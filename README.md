...
> Полный комплект Ansible-ролей и плейбуков для быстрой настройки и управления сервисом [Ponyta](https://github.com/Operator2024/Ponyta)
...
```bash
ansible-playbook -i <path_to_your_inventory> playbooks/ponyta_setup.yaml
```

**Важно:** По умолчанию включен только `prometheus`.
